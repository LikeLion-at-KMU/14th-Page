...
export default function Curriculum() {
  ...
  return (
    <SectionLayout
      ...
      description={
        <>
        개발, 디자인 역량을 키우기 위한 세션을 진행합니다. <br />기본적으로 <span className="text-primary">프론트엔드는 수요일, 백엔드는 목요일, 기획/디자인은 월요일</span>에 진행됩니다.<br />자세한 일정은 추후 공지 예정입니다.
        </>
      }
    >
      <div className="flex w-[580px] flex-col items-center gap-6">
