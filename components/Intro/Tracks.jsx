...
function TrackCard({ roleEn, roleKo, imageSrc }) {
  return (
    <div className="relative overflow-hidden rounded-card bg-surface w-[360px]">
      <div className="relative aspect-[360/460] w-full">
        ...
        {imageSrc ? (
          ...
          <img
            ...
            alt=""
            draggable={false}
            className="absolute left-1/2 top-[52px] h-[237px] w-[250px] -translate-x-1/2 object-contain"
          />
        ) : null}

        <div className="absolute left-[36px] right-[36px] top-[329px] flex flex-col gap-3">
          <p className="text-[20px] font-medium leading-[24px] text-primary">
            {roleEn}
          </p>
          <p className="text-[36px] font-bold leading-[43px] text-text-strong">
            {roleKo}
          </p>
        </div>
      </div>
