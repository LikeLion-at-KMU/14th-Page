  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4">
      ...
      <div className="flex items-end gap-1">
        <span className="text-[56px] font-bold leading-[140%] tracking-[-0.02em] text-primary">{mainValue}</span>
        {hasPlus && (
...
export default function StatsCard() {
  return(
    <div className="relative mx-auto w-full max-w-[912px] rounded-card bg-surface">
