...
export default function Hero() {
  return (
    <div className="mx-auto flex flex-col items-center justify-center w-full max-w-[744px] h-[309px] gap-9 text-center">
      <img src="/LikeLion_Logo.svg" alt="멋사대학 로고" width={207} height={52}/>
      <h1 className="text-[40px] font-bold leading-[53px] text-text-strong ">
        멋쟁이사자처럼 at 국민대
      </h1>

      <p className="text-[20px] font-medium leading-[183%] text-text ">
